...
namespace Chat.Model
{
    public class ConversationRepository : IBaseRepository<Conversation>
    {
        ...
        public Conversation GetById(int id)
        {
            ...
            {
                Id = id,
                Active = Boolean.Parse(result[0][0]),
            ...
            {
                conversation.Buddies.Add(dbController.UserRemoteRepo.GetById(Int32.Parse(row[0])));
            }
            ...
            {
                conversation.Messages.Add(dbController.MessageRepo.GetById(Int32.Parse(row[0])));
            }
